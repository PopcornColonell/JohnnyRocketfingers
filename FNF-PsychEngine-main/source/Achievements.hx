...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Almost Seems Sleepy",							"Beat Suppish on Hard with no Misses.",				'suppish_nomiss',		false],
		["Fatality",									"Beat Brutality on Hard with no Misses.",			'brutality_nomiss',		false],
		["Can Of Whoop-Ass",							"Beat Kickass on Hard with no Misses.",				'kickass_nomiss',		false],
		["Smokin' Hot",									"Beat Johnny Rocketfingers with no Misses.",		'weekj_nomiss',			false],
		...
		["Check Us Out!",								"Open the credits and check out the mod creators.",	'creditsachieve',		 false],
		["/b/ Side",									"Beat Infijohnny on Hard with no Misses.",			'infijohnny_nomiss',		false],
