...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		johnnyintro = new FlxSprite(0, 0);
		johnnyintro.frames = Paths.getSparrowAtlas('johnny_start');
		johnnyintro.antialiasing = ClientPrefs.globalAntialiasing;
		johnnyintro.animation.addByPrefix('move', 'Start Screen BG art', 24);
		johnnyintro.animation.play('move');
		add(johnnyintro);
